Return-Path: <linux-ntb+bncBCKYNX7Y3IMBB3XHSCDQMGQEV7NYSKA@googlegroups.com>
X-Original-To: lists+linux-ntb@lfdr.de
Delivered-To: lists+linux-ntb@lfdr.de
Received: from mail-wm1-x33d.google.com (mail-wm1-x33d.google.com [IPv6:2a00:1450:4864:20::33d])
	by mail.lfdr.de (Postfix) with ESMTPS id 0227F3BCA46
	for <lists+linux-ntb@lfdr.de>; Tue,  6 Jul 2021 12:43:59 +0200 (CEST)
Received: by mail-wm1-x33d.google.com with SMTP id m7-20020a05600c4f47b02901ff81a3bb59sf1708745wmq.2
        for <lists+linux-ntb@lfdr.de>; Tue, 06 Jul 2021 03:43:59 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1625568238; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=mbD8JsvNrnSCVAm/ZQXVtB69N4+b1T0Qza5M+MgMTtk=;
        b=
ARC-Authentication-Results: i=2; gmr-mx.google.com;
       spf=pass (google.com: domain of alexandre.belloni@bootlin.com designates 217.70.183.200 as permitted sender) smtp.mailfrom=alexandre.belloni@bootlin.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mbD8JsvNrnSCVAm/ZQXVtB69N4+b1T0Qza5M+MgMTtk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:x-gm-message-state:date:from:to:cc:subject:message-id
         ...
         :list-subscribe:list-unsubscribe;
        bh=mbD8JsvNrnSCVAm/ZQXVtB69N4+b1T0Qza5M+MgMTtk=;
        b=
Sender: linux-ntb@googlegroups.com
X-Gm-Message-State: AOAM532swNBUZiW+Gti24d/uR3HmIdpwwp2YzXJVU6HzHnUTPpwzDfu5
	dbcBuYHQLYsFnX1Y+hUEo+k=
X-Google-Smtp-Source: ABdhPJxHzIKgA0DE6vhaT4LbLfPShYnw0Vm6cSaBWa2H1tKRYB8PcuWNGOQZFBhR/41AkehA2rwNzw==
X-Received: by 2002:adf:eb43:: with SMTP id u3mr21072450wrn.83.1625568238726;
        Tue, 06 Jul 2021 03:43:58 -0700 (PDT)
X-BeenThere: linux-ntb@googlegroups.com
Received: by 2002:a5d:6ac7:: with SMTP id u7ls908964wrw.0.gmail; Tue, 06 Jul
 2021 03:43:57 -0700 (PDT)
X-Received: by 2002:a5d:5004:: with SMTP id e4mr21263580wrt.205.1625568237746;
        Tue, 06 Jul 2021 03:43:57 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1625568237; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=in-reply-to:content-transfer-encoding:content-disposition
         :mime-version:references:message-id:subject:cc:to:from:date;
        bh=UDJFZuhMMuDpKjDF4tguiSE5oKvS82sNjRNVSVNLLjY=;
        b=
ARC-Authentication-Results: i=1; gmr-mx.google.com;
       spf=pass (google.com: domain of alexandre.belloni@bootlin.com designates 217.70.183.200 as permitted sender) smtp.mailfrom=alexandre.belloni@bootlin.com
Received: from relay7-d.mail.gandi.net (relay7-d.mail.gandi.net. [217.70.183.200])
        by gmr-mx.google.com with ESMTPS id h15si606727wru.3.2021.07.06.03.43.57
        for <linux-ntb@googlegroups.com>
        (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
        Tue, 06 Jul 2021 03:43:57 -0700 (PDT)
Received-SPF: pass (google.com: domain of alexandre.belloni@bootlin.com designates 217.70.183.200 as permitted sender) client-ip=217.70.183.200;
...
X-Original-Authentication-Results: gmr-mx.google.com;       spf=pass
 ...
 217.70.183.200 as permitted sender) smtp.mailfrom=alexandre.belloni@bootlin.com
Precedence: list
...
On 06/07/2021 11:50:37+0200, Uwe Kleine-K=C3=B6nig wrote:
...
>  			dev_warn(_dev, "remove callback returned a non-zero value. This will =
be ignored.\n");
>  	}
...
;
>  	struct bcma_driver *adrv =3D container_of(dev->driver, struct bcma_driv=
er,
...
>  	struct tifm_driver *drv =3D container_of(dev->driver, struct tifm_drive=
r,
...
linux-ntb/YOQz2zoBdU9evwel%40piout.net.
